export default function NotFound() {
    return (
        <div className="w-[100vw] h-[100vh] flex justify-center items-center not-found-bg">
			<div className="max-w-[700px] text-center bg-black bg-opacity-60 text-white rounded-xl p-6 font-trebuchet">
				<h1 className="text-5xl font-bold mb-4 text-[#dcbadc]">404</h1>
				...
				<a href="/" className="bg-[#60346b] hover:bg-purple-800 px-4 py-1 rounded-lg text-xl">Go Home</a>
			</div>
		</div>
	);
}